...
namespace LocalChatBot.Services.Ingestion;
    ...
    IngestionCacheDbContext ingestionCacheDb)
{
    ...
    public async Task IngestDataAsync(IIngestionSource source)
    {
        ...
        if (ingestionCacheDb.Documents != null)
        {
            ...
            foreach (var modifiedDoc in modifiedDocs)
            {
                ...
                var newRecords = (await source.CreateRecordsForDocumentAsync(embeddingGenerator, modifiedDoc.Id)).ToArray();
